...
def test_file_diff():
    ...
    file_diff = FileDiff(name="test.py", diff="@@ -1,3 +1,3 @@")
...
def test_ai_review_request():
    ...
    request = AIReviewRequest(diff="@@ -1,3 +1,3 @@", filename="test.py", context="Test context")
...
def test_ai_review_response():
    ...
    comment = ReviewComment(path="test.py", line=10, body="Test comment")
    response = AIReviewResponse(comments=[comment], summary="Test summary")
